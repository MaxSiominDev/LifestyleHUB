...
class WeatherViewModel @Inject constructor(
    ...
    data class State(
        val weather: dev.maxsiomin.prodhse.feature.home.domain.WeatherModel? = null,
    ...
    val emptyCardContent
        get() = dev.maxsiomin.prodhse.feature.home.data.mappers.WeatherDtoToUiModelMapper().invoke(dev.maxsiomin.prodhse.feature.home.data.dto.current_weather_response.CurrentWeatherResponse(), previousIsNight)
